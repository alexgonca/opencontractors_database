...
def transform_row(record):
    ...
    new_record['contractor_state'] = nullify_text(record['state'])
    new_record['contractor_state_redundant'] = nullify_text(record['vendor_state_code'])
    ...
    new_record['claimant_program'] = left_text_and_upper(record['claimantprogramcode'])
