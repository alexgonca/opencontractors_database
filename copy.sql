CREATE TABLE IF NOT EXISTS contract (
  id SERIAL CONSTRAINT pk_contract_test_id PRIMARY KEY,
  unique_transaction_id VARCHAR(32) NOT NULL,
  last_modified_date DATE NOT NULL,
  CONSTRAINT u_contract_test unique (unique_transaction_id, last_modified_date),
...
'/home/alex/PycharmProjects/opencontractorsdatabasev2/datafeeds/datafeeds/result.csv'
CSV HEADER;

truncate contract_test;


select * from contract_test;